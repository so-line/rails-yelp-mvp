...
if defined?(ReviewsController)
  RSpec.describe ReviewsController, type: :controller do
    ...
    describe 'GET new', refactored: false do
      it 'routes to #new' do
        expect(get: '/restaurants/1/reviews/new').to route_to(controller: 'reviews', action: 'new',
                                                              restaurant_id: '1')
      end
    ...
    describe 'POST create' do
      it 'routes to #create' do
        expect(post: '/restaurants/1/reviews').to route_to(controller: 'reviews', action: 'create',
                                                           restaurant_id: '1')
      end
